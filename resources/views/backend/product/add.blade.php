                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10"> 
                            <input min="0" type="number" type="text" class="form-control" name="txtgia" placeholder="Giá sản phẩm..." value="{!! old('txtgia') !!}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10"> 
                            <input min="0" type="number" type="number" class="form-control" name="txtqty" placeholder="Số lượng sản phẩm" value="{!! old('txtqty') !!}">
                        </div>
                      </div>
                     <div class="form-group">
