                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10"> 
                            <input min="0" type="number" class="form-control" name="txtgia" placeholder="Giá sản phẩm..." value="{!! old('txtgia',isset($product)?$product["price"]:"") !!}">
                        </div>
                      </div>

                      <div class="form-group">
                        <label for="txtgiasale" class="col-md-2">Giá khuyến mại</label>
                        <div class="col-md-10" id="giakhuyenmai"> 
                            <input type="text" class="form-control" name="txtgiasale" placeholder="Giá khuyến mại nhập theo % ví dụ : 10" value="{!! old('txtgiasale') !!}" >
                        </div>
                      </div>
                       <div class="form-group">
                        <label for="txtqty" class="col-md-2">Số Lượng</label>
                        <div class="col-md-10"> 
                            <input min="0" type="number" class="form-control" name="txtqty" placeholder="Số lượng sản phẩm" value="{!! old ('txtqty',isset($product)?$product["qty"]:"") !!}">
                        </div>
                      </div>
                     <div class="form-group">
                        <label for="txtndhienthi" class="col-md-2">Giới thiệu</label>
                        <div class="col-md-10"> 
